        ...
        <div className="container">
          ...
          >
            ...
            <div className="mobile-menu-top">
              <a href="tel:+36204078868" className="phone mobile-phone">
                <Phone size={18} />
                +36 20 407 8868
              </a>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
              <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: '2rem', width: '100%' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.7rem' }}>
                  <a href="tel:+36204078868" className="phone" style={{ fontWeight: 500, fontSize: '1.08rem', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                    <Phone size={18} />
                    +36 20 407 8868
                  </a>
