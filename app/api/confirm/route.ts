  ...
  try {
    ...
    if (action === "accept") {
      ...
      try {
        ...
        const startDateTimeLocal = `${updatedBooking.originalDate}T${from.trim()}:00`;
        const endDateTimeLocal = `${updatedBooking.originalDate}T${to.trim()}:00`;
        ...
        console.log('Final datetime for calendar:', {
          startDateTime,
          endDateTime
        });
