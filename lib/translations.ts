...
export const translations: Record<Locale, TranslationObject> = {
  hu: {
    ...
    faq_a_2: "A legtöbb javítás akár napon belül, de legfeljebb 1-3 munkanapon belül elkészül, de a pontos időt a hiba és az alkatrész-ellátottság is befolyásolja. A háztól-házig szerviznek köszönhetően Önnek nem kell sorban állnia!",
    ...
    service_desc_3: "Gyorsan merülő vagy hibás akkumulátor cseréje, cellateszt, töltési problémák feltárása. Minőségi akkumulátorok beszerelése! Háztól házig szerviz az alapdíjban!",
  ...
  en: {
    ...
    faq_a_2: "Most repairs are often completed the same day, but at latest within 1-3 business days. The exact time depends on the fault and parts availability. With our door-to-door service, you don’t have to wait in line!",
